...
<head>
    <title>Welcome our customer.</title>
        ...
        <div class="container mx-auto flex justify-between">
            ...
            <ul class="flex">
                ...
                <li class="" style="color: #FFA500">
                    <a href="#" class="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold">Welcome our
                        customer {{ Auth::user()->name }}</a>
                </li>

                <li class="" style="color: #FFA500">
                    <a href="/user/addhisa" class="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold">Weka
                        hisa</a>
                </li>

                <li class="" style="color: #FFA500">
                    <a href="/user/myvikobas"
                        class="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold">Hisa zangu
                    </a>
                </li>
    ...
    <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
        ...
        {{--  <div>
            @foreach ($vikobas as $vikoba)
                <p>{{ $order->user->name }}</p>
                <p>{{ $order->location }}</p>
                <p>{{ $order->msosi->foodname }}</p>
                <p>{{ $order->quantity }}</p>
                <p>{{ $order->msosi->price }}</p>
            @endforeach
        </div>  --}}
    </div>
