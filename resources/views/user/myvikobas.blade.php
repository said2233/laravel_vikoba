...
<body class="bg-gray-100 text-gray-900 tracking-wider leading-normal">
    ...
    <div class="container w-full md:w-4/5 xxxl:w-3/5  mx-auto px-2">
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            ...
            <a class="bg-green-500 text-white px-2 py-1 rounded text-left" href="">The total Hisa
                for {{ Auth::user()->name }} is {{ $sumHisa }}</a>
                ...
                <tbody>
                    @foreach ($vikobas as $vikoba)
                        <tr>
                            ...
                            <td class="border">
                                <a
                                    class="bg-green-500 text-white rounded-md px-2 py-0.5 shadow-md"href="{{ route('vikoba.edit', $vikoba->id) }}">Edit</a>
                                ...
                                <form action="{{ route('vikoba.delete', ['id' => $vikoba->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                                        class="bg-red-500 text-white rounded-md px-2 py-0.5 shadow-md"
